...
const Search = () => {
  ...
  const {requests,error,searchuser,loading} = React.useContext(Github);
  ...
  return <section className='section'>
    <Wrapper className='section-center'>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <MdSearch/>
          <input type="text" placeholder='enter the user name' value={search} onChange={(e)=>{setsearh(e.target.value)}}/>
